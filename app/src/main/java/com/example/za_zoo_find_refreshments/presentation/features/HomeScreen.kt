package com.example.za_zoo_find_refreshments.presentation.features
        ...
        Box(
            Modifier
                .graphicsLayer {
                    ...
                    // Apply rotation only when the item is not the current page
                    ...
                    // Apply scale based on page offset
                    val scale = lerp(
                        start = 0.70f,
                        stop = 1f,
                        fraction = 1f - pageOffset.coerceIn(0f, 1f)
